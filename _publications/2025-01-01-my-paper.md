...
excerpt: '从微观技术角度来看，当下CNN和Transformer架构创新进入平台期，多数据模型的性能提升依赖于更大的参数量与数据集。在成熟路线的基础上进行冻结模型参数是个新的研究热点。我从ICML 2024的领域内文章获得启发，利用多模态大语言模型的思维链和多模态能力，直接作用于扩散模型Latent空间底层对生成内容进行规划指导，拓展了免训练策略的全新适用场景，实现多模态大语言模型指导的免训练多参考图个性化生成。'
